...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    public function getBundle(string $name): BundleInterface
    {
        if (!isset($this->bundles[$name])) {
            throw new \InvalidArgumentException(sprintf('Bundle "%s" does not exist or it is not enabled. Maybe you forgot to add it in the "registerBundles()" method of your "%s.html" file?', $name, get_debug_type($this)));
        }
    ...
    protected function initializeContainer()
    {
        ...
        $cache = new ConfigCache($buildDir.'/'.$class.'.html', $this->debug);
        ...
        if ($preload && method_exists(Preloader::class, 'append') && file_exists($preloadFile = $buildDir.'/'.$class.'.preload.html')) {
