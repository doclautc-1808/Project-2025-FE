...
Guzzle now uses [PSR-7](https://www.html-fig.org/psr/psr-7/) for HTTP messages.
...
- Static functions in `GuzzleHttp\Utils` have been moved to namespaced
  ...
  based autoloader or you to include functions.html.
...
## Removed functions.html

Removed "functions.html", so that Guzzle is truly PSR-4 compliant. The following
...
- `GuzzleHttp\StaticClient` has been removed. Use the functions provided in
  `functions.html` for an easy to use static client instance.
