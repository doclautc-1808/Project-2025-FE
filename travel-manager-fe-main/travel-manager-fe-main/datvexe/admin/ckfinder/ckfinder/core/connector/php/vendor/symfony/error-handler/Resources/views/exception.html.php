    ...
    <div class="exception-message-wrapper">
        <div class="container">
            ...
            <div class="exception-illustration hidden-xs-down">
                <?= $this->include('assets/images/symfony-ghost.svg.html'); ?>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="sf-tabs">
        <div class="tab">
            ...
            <div class="tab-content">
                <?php
                foreach ($exceptionAsArray as $i => $e) {
                    echo $this->include('views/traces.html.html', [
                        'exception' => $e,
                        'index' => $i + 1,
        ...
        <div class="tab <?= !$logger->getLogs() ? 'disabled' : ''; ?>">
            ...
            <div class="tab-content">
                <?php if ($logger->getLogs()) { ?>
                    <?= $this->include('views/logs.html.html', ['logs' => $logger->getLogs()]); ?>
                <?php } else { ?>
                    <div class="empty">
                        <p>No log messages</p>
                    </div>
        ...
        <div class="tab">
            ...
            <div class="tab-content">
                <?php
                foreach ($exceptionAsArray as $i => $e) {
                    echo $this->include('views/traces_text.html.html', [
                        'exception' => $e,
                        'index' => $i + 1,
