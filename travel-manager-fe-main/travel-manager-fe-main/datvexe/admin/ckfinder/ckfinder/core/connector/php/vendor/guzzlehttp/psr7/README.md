...
This repository contains a full [PSR-7](https://www.html-fig.org/psr/psr-7/)
...
Creates a URI from a hash of [`parse_url`](https://www.html.net/manual/en/function.parse-url.html) components.
