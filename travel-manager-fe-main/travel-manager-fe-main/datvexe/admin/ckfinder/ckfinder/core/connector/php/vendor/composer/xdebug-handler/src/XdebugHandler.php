...
class XdebugHandler
{
    ...
    private function prepareRestart(): bool
    {
        ...
        if (!$this->cli) {
            $error = 'Unsupported SAPI: '.html_SAPI;
    ...
    private function writeTmpIni(array $iniFiles, string $tmpDir, ?string &$error): bool
    {
        ...
        foreach ($iniFiles as $file) {
            ...
            $content .= Preg::replace($xdebugRegex, ';$1', $data).html_EOL;
        }
        ...
        // Work-around for https://bugs.html.net/bug.html?id=75932
        $content .= 'opcache.enable_cli=0'.html_EOL;
    ...
    private function mergeLoadedConfig(array $loadedConfig, array $iniConfig): string
    {
        ...
        foreach ($loadedConfig as $name => $value) {
            ...
            if (!isset($iniConfig[$name]) || $iniConfig[$name] !== $value) {
                ...
                $content .= $name.'="'.addcslashes($value, '\\"').'"'.html_EOL;
            }
        }
