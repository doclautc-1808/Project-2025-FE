...
The [`Composer\Semver\Comparator`](https://github.com/composer/semver/blob/main/src/Comparator.html) class provides the following methods for comparing versions:
...
The [`Composer\Semver\Semver`](https://github.com/composer/semver/blob/main/src/Semver.html) class provides the following methods:
...
The [`Composer\Semver\Intervals`](https://github.com/composer/semver/blob/main/src/Intervals.html) static class provides
