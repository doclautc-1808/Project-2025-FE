...
* bug #6089 TokensAnalyzer.html - Fix T_ENCAPSED_AND_WHITESPACE handling in isBina… (SpacePossum)
...
* minor #5218 DX: .gitignore - add .htmlunit.result.cache (keradus)
...
* minor #4918 DX: do not fix ".htmlt" files by default (kubawerlos)
...
* minor #3087 phar-stub.html - allow PHP 7.2 (keradus)
...
* minor #3032 .html_cs.dist - handling UnexpectedValueException (keradus)
...
* minor #2383 update .html_cs.dist configuration (keradus)
...
* minor #2426 .html_cs.dist - update local CS config (keradus)
...
* minor #2447 .html_cs.dist - update local CS config (keradus)
* minor #2452 Provide rules definitions (keradus)
...
* feature #829 add support for .html_cs.dist file (keradus)
...
* minor #1733 ConfigurationResolver - look for .html_cs file in cwd as well (keradus)
...
* minor #1906 .html_cs - use no_useless_else rule (keradus)
...
* minor #1319 PhpUnitConstructFixer - fix performance and add to local .html_cs (keradus)
...
* bug #1071 Psr0Fixer - fix bug for fixing file with long extension like .class.html (keradus)
