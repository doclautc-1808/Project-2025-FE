...
class Utils
{
     ...
     *
     * @see http://pl.html.net/manual/en/function.ini-get.html
     *
     * @param string $val
     *
     * @return int
     ...
     * If the script is executed with CLI, as a relative path, such as `file.html` or `../file.html`,
    ...
    public static function getRootPath()
    {
         ...
         * For instance, <code>$_SERVER['PHP_SELF']</code> in a script at the address `http://example.com/test.html/foo.bar`
         * would be `/test.html/foo.bar`.
         */
     ...
     * See @see http://php.net/manual/en/function.session-cache-limiter.html.
     */
