...
| 2.x              | 3.0                      | Description                            |
| ---------------- | ------------------------ | -------------------------------------- |
| `.html_cs`        | `.html-cs-fixer.html`      | Configuration file (local)             |
| `.html_cs.dist`   | `.html-cs-fixer.dist.html` | Configuration file (to be distributed) |
| `.html_cs.cache`  | `.html-cs-fixer.cache`    | Cache file                             |
