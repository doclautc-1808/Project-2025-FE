...
class TCPDF_FONTS {
	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		if (@TCPDF_STATIC::file_exists($outpath.$font_name.'.html')) {
			...
			if ($fmetric['type'] == 'cidfont0') {
				...
				switch ($fonttype) {
					case 'CID0JP': {
						...
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_aj16.html\');'."\n";
						break;
					}
					case 'CID0KR': {
						$pfile .= '// Korean'."\n";
						...
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_ak12.html\');'."\n";
						break;
					}
					case 'CID0CS': {
						...
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_ag15.html\');'."\n";
						break;
					}
					case 'CID0CT':
					default: {
		...
		$pfile .= '// --- EOF ---'."\n";
		// store file
		$fp = TCPDF_STATIC::fopenLocal($outpath.$font_name.'.html', 'w');
		fwrite($fp, $pfile);
		fclose($fp);
