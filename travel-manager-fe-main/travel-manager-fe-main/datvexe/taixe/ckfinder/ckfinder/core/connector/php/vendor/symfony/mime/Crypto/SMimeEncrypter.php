...
final class SMimeEncrypter extends SMime
{
     ...
     * @param int|null        $cipher      A set of algorithms used to encrypt the message. Must be one of these PHP constants: https://www.html.net/manual/en/openssl.ciphers.html
     */
