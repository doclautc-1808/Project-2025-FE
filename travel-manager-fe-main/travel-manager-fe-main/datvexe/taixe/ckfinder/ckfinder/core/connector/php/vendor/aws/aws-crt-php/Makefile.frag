...
ext/awscrt_arginfo.h: ext/awscrt.stub.html gen_stub.html
ifeq ($(GENERATE_STUBS),1)
	# generate awscrt_arginfo.h
	php gen_stub.html --minimal-arginfo ext/awscrt.stub.html
endif

# transform/install api.h from FFI lib
src/api.h: crt/aws-crt-ffi/src/api.h
	php gen_api.html crt/aws-crt-ffi/src/api.h > src/api.h
