...
final class FixerFactory
{
    ...
    public function registerBuiltInFixers(): self
    {
        ...
        if (null === $builtInFixers) {
            ...
            foreach (SymfonyFinder::create()->files()->in(__DIR__.'/Fixer')->name('*Fixer.html')->depth(1) as $file) {
                $relativeNamespace = $file->getRelativePath();
                $fixerClass = 'PhpCsFixer\\Fixer\\'.($relativeNamespace ? $relativeNamespace.'\\' : '').$file->getBasename('.html');
