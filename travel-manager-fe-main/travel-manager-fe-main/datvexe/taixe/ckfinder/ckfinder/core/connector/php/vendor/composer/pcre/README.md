...
See the [MatchResult](src/MatchResult.html), [MatchWithOffsetsResult](src/MatchWithOffsetsResult.html), [MatchAllResult](src/MatchAllResult.html),
[MatchAllWithOffsetsResult](src/MatchAllWithOffsetsResult.html), and [ReplaceResult](src/ReplaceResult.html) class sources for more details.
