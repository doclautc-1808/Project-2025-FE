...
special_src='(gen_api.html|gen_stub.html|CMakeLists.txt|post.sh|postun.sh|Makefile*|build-buildspec.sh|build-deps.sh|objects.txt|go.*|BUILD*|DEPS|install_and_run.sh|codemod.sh|requirements.txt)'
...
special_scripts='(awscrt.stub.html)'
