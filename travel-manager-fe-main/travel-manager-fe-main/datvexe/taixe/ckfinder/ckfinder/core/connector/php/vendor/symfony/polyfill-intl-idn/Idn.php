...
final class Idn
{
    ...
    private static function isValidContextJ(array $codePoints, $label)
    {
        if (!isset(self::$virama)) {
            self::$virama = require __DIR__.\DIRECTORY_SEPARATOR.'Resources'.\DIRECTORY_SEPARATOR.'unidata'.\DIRECTORY_SEPARATOR.'virama.html';
        }
    ...
    private static function lookupCodePointStatus($codePoint, $useSTD3ASCIIRules)
    {
        if (!self::$mappingTableLoaded) {
            ...
            self::$mapped = require __DIR__.'/Resources/unidata/mapped.html';
            self::$ignored = require __DIR__.'/Resources/unidata/ignored.html';
            self::$deviation = require __DIR__.'/Resources/unidata/deviation.html';
            self::$disallowed = require __DIR__.'/Resources/unidata/disallowed.html';
            self::$disallowed_STD3_mapped = require __DIR__.'/Resources/unidata/disallowed_STD3_mapped.html';
            self::$disallowed_STD3_valid = require __DIR__.'/Resources/unidata/disallowed_STD3_valid.html';
        }
