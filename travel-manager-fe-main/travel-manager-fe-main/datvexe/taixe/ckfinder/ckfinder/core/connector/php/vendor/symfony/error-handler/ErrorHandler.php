...
class ErrorHandler
{
    ...
    public static function register(self $handler = null, bool $replace = true): self
    {
        ...
        if (null === $prev = set_error_handler([$handler, 'handleError'])) {
            ...
            // Specifying the error types earlier would expose us to https://bugs.html.net/63206
    ...
    {
        return preg_replace_callback('/[a-zA-Z_\x7f-\xff][\\\\a-zA-Z0-9_\x7f-\xff]*+@anonymous\x00.*?\.html(?:0x?|:[0-9]++\$)[0-9a-fA-F]++/', static function ($m) {
