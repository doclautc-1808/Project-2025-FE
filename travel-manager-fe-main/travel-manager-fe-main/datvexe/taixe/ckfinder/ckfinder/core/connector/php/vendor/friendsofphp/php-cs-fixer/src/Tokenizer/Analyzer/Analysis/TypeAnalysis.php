...
final class TypeAnalysis implements StartEndTokenAwareAnalysis
{
     ...
     * More info:
     *
     * @see https://php.net/manual/en/functions.arguments.html#functions.arguments.type-declaration.types
     * @see https://php.net/manual/en/reserved.other-reserved-words.html
     * @see https://php.net/manual/en/language.pseudo-types.html
     *
     * @var list<string>
     */
