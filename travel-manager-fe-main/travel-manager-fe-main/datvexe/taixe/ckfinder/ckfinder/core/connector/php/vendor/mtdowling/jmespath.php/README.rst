...
extract elements from a JSON document. *jmespath.html* allows you to use
...
using the ``mtdowling/jmespath.html`` package.
...
jmespath.html utilizes *runtimes*. There are currently two runtimes:
...
https://github.com/jmespath/jmespath.html/tree/master/tests/compliance.
These compliance tests are utilized by jmespath.html to ensure consistency with
other implementations, and can serve as examples of the language.

jmespath.html is tested using PHPUnit. In order to run the tests, you need to
