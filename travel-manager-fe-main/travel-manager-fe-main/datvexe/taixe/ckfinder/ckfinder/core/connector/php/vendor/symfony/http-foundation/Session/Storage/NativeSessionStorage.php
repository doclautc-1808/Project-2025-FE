...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    public function start(): bool
    {
         ...
         * See https://www.html.net/manual/en/session.configuration.html#ini.session.sid-bits-per-character.
         ...
         * See https://www.html.net/manual/en/session.configuration.html#ini.session.sid-length.
