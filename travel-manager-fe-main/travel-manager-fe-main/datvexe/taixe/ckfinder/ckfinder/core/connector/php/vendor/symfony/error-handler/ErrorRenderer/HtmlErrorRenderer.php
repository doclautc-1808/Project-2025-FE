...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    private static string $template = 'views/error.html.html';
    ...
    {
        return $this->renderException($exception, 'views/exception.html.html');
    }
    ...
    private function renderException(FlattenException $exception, string $debugTemplate = 'views/exception_full.html.html'): string
    {
