<?php
//============================================================+
// File name   : tcpdf_autoconfig.html
// Version     : 1.1.1
// Begin       : 2013-05-16
...
if (!defined('K_TCPDF_EXTERNAL_CONFIG') OR !K_TCPDF_EXTERNAL_CONFIG) {
	...
	$tcpdf_config_files = array(dirname(__FILE__).'/config/tcpdf_config.html', '/etc/php-tcpdf/tcpdf_config.html', '/etc/tcpdf/tcpdf_config.html', '/etc/tcpdf_config.html');
