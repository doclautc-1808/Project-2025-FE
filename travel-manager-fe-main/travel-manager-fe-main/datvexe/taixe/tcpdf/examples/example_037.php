...
require_once('tcpdf_include.html');
...
if (@file_exists(dirname(__FILE__).'/lang/eng.html')) {
	require_once(dirname(__FILE__).'/lang/eng.html');
...
// --- default values defined on spotcolors.html ---
