<?php
//============================================================+
// File name   : tcpdf_barcodes_2d_include.html
// Begin       : 2013-05-19
...
$tcpdf_barcodes_2d_include_dirs = array(
    realpath(dirname(__FILE__) . '/../../tcpdf_barcodes_2d.html'),// True source file
	realpath('../../tcpdf_barcodes_2d.html'),// Relative from $PWD
	'/usr/share/php/tcpdf/tcpdf_barcodes_2d.html',
	'/usr/share/tcpdf/tcpdf_barcodes_2d.html',
	'/usr/share/php-tcpdf/tcpdf_barcodes_2d.html',
	'/var/www/tcpdf/tcpdf_barcodes_2d.html',
	'/var/www/html/tcpdf/tcpdf_barcodes_2d.html',
	'/usr/local/apache2/htdocs/tcpdf/tcpdf_barcodes_2d.html'
);
